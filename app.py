...
def generate_caption(image, processor, model, max_length=20):
    """
...
def generate_explanation(image, processor, model):
    """
...
def main():
    ...
    if image_loaded and image is not None:
        ...
        if image is not None:
            ...
            with col2:
                # Generate button
                if st.button("✨ Generate Caption and Explanation", type="primary"):
                    with st.spinner("Generating caption and explanation..."):
                        # Generate caption
                        caption = generate_caption(image, processor, model)
                        
                        # Generate explanation
                        explanation = generate_explanation(image, processor, model)
    ...
    st.markdown(
        ...
        Powered by Hugging Face's BLIP model and Streamlit
        </div>
        """,
